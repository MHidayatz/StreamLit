...
# Install spacy: https://www.projectpro.io/recipes/install-and-use-spacy-models
import spacy
...
def text_analyzer(my_text):
    ...
    df = pd.DataFrame(allData, columns=['Token','Shape','PoS','Tag','Lemma','IsAlpha','IsStopWord'])
    return df
